...
describe('BotchedError', () => {
  it('should not touch a BotchedError with status 400-499', () => {
  ...
  it('should not touch a BotchedError with status >= 500', () => {
  ...
  it('should not touch a BotchedError with invalid status', () => {
